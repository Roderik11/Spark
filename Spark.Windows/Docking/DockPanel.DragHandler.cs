...
namespace Spark.Windows
{
    partial class DockPanel
    {
        ...
        private abstract class DragHandlerBase : NativeWindow, IMessageFilter
        {
            ...
            {
                if (m.Msg == (int)Win32Native.Msgs.WM_CANCELMODE || m.Msg == (int)Win32Native.Msgs.WM_CAPTURECHANGED)
                    EndDrag(true);
        ...
        private abstract class DragHandler : DragHandlerBase
        {
            ...
            {
                if ((m.Msg == (int)Win32Native.Msgs.WM_KEYDOWN || m.Msg == (int)Win32Native.Msgs.WM_KEYUP) &&
