    ...
    partial class DockPanel
    {
        ...
        private class FocusManagerImpl : Component, IContentFocusManager, IFocusManager
        {
            ...
            private class LocalWindowsHook : IDisposable
            {
                ...
                public LocalWindowsHook(Win32Native.HookType hook)
                {
                    m_hookType = hook;
            ...
            public FocusManagerImpl(DockPanel dockPanel)
            {
                ...
                m_localWindowsHook = new LocalWindowsHook(Win32Native.HookType.WH_CALLWNDPROCRET);
            ...
            {
                Win32Native.Msgs msg = (Win32Native.Msgs)Marshal.ReadInt32(e.lParam, IntPtr.Size * 3);

                if (msg == Win32Native.Msgs.WM_KILLFOCUS)
                {
                ...
                else if (msg == Win32Native.Msgs.WM_SETFOCUS)
                    RefreshActiveWindow();
            }
