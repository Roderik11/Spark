	...
	internal class DragForm : Form
	{
		...
		protected override CreateParams CreateParams
		{
			get
			{
				...
				createParams.ExStyle |= (int)Win32Native.WindowExStyles.WS_EX_TOOLWINDOW;
				return createParams;
			}
		}
		...
		{
			if (m.Msg == (int)Win32Native.Msgs.WM_NCHITTEST)
			{
				m.Result = (IntPtr)Win32Native.HitTest.HTTRANSPARENT;
				return;
			}
