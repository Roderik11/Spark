...
namespace Jitter.Collision
{
    ...
    public class CollisionSystemPersistentSAP : CollisionSystem
    {
        ...
        #endregion private class SweepPoint
        ...
        #endregion private struct OverlapPair
        ...
        private Action<object> detectCallback, sortCallback;
        ...
        private List<IBroadphaseEntity> activeList = new List<IBroadphaseEntity>();
        ...
        #endregion Incoherent Update - Quicksort
        ...
        #endregion Coherent Update - Insertionsort
        ...
        private Stack<OverlapPair> depricated = new Stack<OverlapPair>();
        ...
        #endregion public override bool Raycast(JVector rayOrigin, JVector rayDirection, out JVector normal,out float fraction)
        ...
        #endregion public override bool Raycast(RigidBody body, JVector rayOrigin, JVector rayDirection, out JVector normal, out float fraction)
    }
}