...
namespace Jitter.Collision
{
    ...
    #endregion public struct TriangleVertexIndices
    ...
    public class Octree
    {
        ...
        #endregion public void AddTriangles(List<JVector> positions, List<TriangleVertexIndices> tris)
        ...
        #endregion public void BuildOctree()
        ...
        #endregion private void CreateAABox(ref JBBox aabb, EChild child,out JBBox result)
        ...
        #endregion private void GatherTriangles(int nodeIndex, ref List<int> tris)
        ...
        #endregion public int GetTrianglesIntersectingtAABox(List<int> triangles, ref JBBox testBox)
        ...
        #endregion public int GetTrianglesIntersectingtRay(JVector rayOrigin, JVector rayDelta)
        ...
        #endregion public TriangleVertexIndices GetTriangleVertexIndex(int index)
        ...
        #endregion public JVector GetVertex(int vertex)
        ...
        #endregion public int NumTriangles
    }
}