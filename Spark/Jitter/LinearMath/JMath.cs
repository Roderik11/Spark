...
namespace Jitter.LinearMath
{
    ...
    public sealed class JMath
    {
        ...
        #endregion public static float Sqrt(float number)
        ...
        #endregion public static float Max(float val1, float val2)
        ...
        #endregion public static float Min(float val1, float val2)
        ...
        #endregion public static float Max(float val1, float val2,float val3)
        ...
        #endregion public static float Clamp(float value, float min, float max)
        ...
        #endregion public static void Absolute(ref JMatrix matrix,out JMatrix result)
    }
}