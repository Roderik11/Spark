...
namespace Jitter.LinearMath
{
    ...
    public struct JMatrix
    {
        ...
        #endregion public JMatrix(float m11, float m12, float m13, float m21, float m22, float m23,float m31, float m32, float m33)
        ...
        #endregion public float Determinant()
        ...
        #endregion public static JMatrix Multiply(JMatrix matrix1, JMatrix matrix2)
        ...
        #endregion public static JMatrix Add(JMatrix matrix1, JMatrix matrix2)
        ...
        #endregion public static JMatrix Inverse(JMatrix matrix)
        ...
        #endregion public static JMatrix Multiply(JMatrix matrix1, float scaleFactor)
        ...
        #endregion public static JMatrix CreateFromQuaternion(JQuaternion quaternion)
        ...
        #endregion public static JMatrix Transpose(JMatrix matrix)
        ...
        #endregion public static JMatrix operator *(JMatrix value1,JMatrix value2)
        ...
        #endregion public static void CreateFromAxisAngle(ref JVector axis, float angle, out JMatrix result)

        #region operators

        public static implicit operator Matrix(JMatrix matrix)
        {
        ...
        public static implicit operator JMatrix(Matrix matrix)
        {
