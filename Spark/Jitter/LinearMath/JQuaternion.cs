...
namespace Jitter.LinearMath
{
    ...
    public struct JQuaternion
    {
        ...
        #endregion public static JQuaternion Add(JQuaternion quaternion1, JQuaternion quaternion2)
        ...
        #endregion public static JQuaternion Subtract(JQuaternion quaternion1, JQuaternion quaternion2)
        ...
        #endregion public static JQuaternion Multiply(JQuaternion quaternion1, JQuaternion quaternion2)
        ...
        #endregion public static JQuaternion Multiply(JQuaternion quaternion1, float scaleFactor)
        ...
        #endregion public static JQuaternion CreateFromMatrix(JMatrix matrix)
        ...
        #endregion public static float operator *(JQuaternion value1, JQuaternion value2)
        ...
        public static implicit operator SharpDX.Quaternion(JQuaternion vector)
        {
            return new SharpDX.Quaternion(vector.X, vector.Y, vector.Z, vector.W);
        }

        public static implicit operator JQuaternion(SharpDX.Quaternion vector)
        {
            return new JQuaternion(vector.X, vector.Y, vector.Z, vector.W);
        }
