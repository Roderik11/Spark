...
namespace Jitter
{
    ...
    public class World
    {
        ...
        #endregion private void ArbiterCallback(object obj)
        ...
        private void IntegrateForces()
        {
            foreach (RigidBody body in rigidBodies)
            {
                ...
                {
                    body.linearVelocity.Y *= body.GravityWeight;
                    ...
                    if (body.affectedByGravity && body.GravityWeight > 0)
                    {
                        JVector.Multiply(ref gravity, timestep * body.GravityWeight, out temp);
        ...
        #endregion private void IntegrateCallback(object obj)
