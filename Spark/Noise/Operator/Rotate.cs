...
namespace Spark.Noise.Operator
{
    ...
    public class Rotate : ModuleBase
    {
        ...
        {
            double xc = Math.Cos(x * NoiseUtils.DegToRad);
            double yc = Math.Cos(y * NoiseUtils.DegToRad);
            double zc = Math.Cos(z * NoiseUtils.DegToRad);
            double xs = Math.Sin(x * NoiseUtils.DegToRad);
            double ys = Math.Sin(y * NoiseUtils.DegToRad);
            double zs = Math.Sin(z * NoiseUtils.DegToRad);
