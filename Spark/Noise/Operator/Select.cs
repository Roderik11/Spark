namespace Spark.Noise.Operator
{
    ...
    public class Select : ModuleBase
    {
        ...
        public override double GetValue(double x, double y, double z)
        {
            ...
            double cv = this.m_modules[1].GetValue(x, y, z);
            double a;
            if (this.m_fallOff > 0.0)
            {
                ...
                else if (cv < (this.m_min + this.m_fallOff))
                {
                    ...
                    a = NoiseUtils.MapCubicSCurve((cv - lc) / (uc - lc));
                    return NoiseUtils.InterpolateLinear(this.m_modules[0].GetValue(x, y, z), this.m_modules[1].GetValue(x, y, z), a);
                }
                ...
                else if (cv < (this.m_max + this.m_fallOff))
                {
                    ...
                    a = NoiseUtils.MapCubicSCurve((cv - lc) / (uc - lc));
                    return NoiseUtils.InterpolateLinear(this.m_modules[1].GetValue(x, y, z), this.m_modules[0].GetValue(x, y, z), a);
                }
